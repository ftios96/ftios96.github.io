...
function getTrueRandomInteger(min, max) {
    ...
    var url;
    url = "./hung.php?min=" + min + "&max=" + max + "&export=1";
    begin = new Date().getTime();
    document.getElementById("true-random-integer-generator-result").innerHTML = '<img src="./ajax-loader.gif" alt="Äang táº£i..." />';
...
function updateTrngDisplayAjax() {
    if (xmlHttp.readyState < 4) { document.getElementById("true-random-integer-generator-result").innerHTML = '<img src="./ajax-loader.gif" alt="Äang táº£i..." />'; }
...
function integerJsInputControl(keyp) {
    ...
    if (unicode == 13) { getTrueRandomInteger(document.getElementById('true-random-integer-generator-min').value, document.getElementById('true-random-integer-generator-max').value); return true; }
